...
namespace VerVad_API.Controllers
{
    ...
    {
        private readonly IGGAndAVRepository<GlobalGoal, int> _repo = new Facade().GetGlobalGoalRepository();
        private readonly GlobalGoalHelper _helper = new GlobalGoalHelper();
